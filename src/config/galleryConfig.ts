...
export const galleryConfig: GalleryConfig = {
	...
	albums: [
		...
		{
			id: "walls",
			name: "My Favorite Wallpapers",
			description: "This is a collection of my favorite wallpapers",
			location: "Desktop Wallpaper",
			date: "2026-08-10",
			tags: ["wallpaper", "collection"],
			password: "mywall123",
			passwordHint: "The password isn't 123456",
		},
		{
			id: "ricing",
			name: "My Linux Journey",
			description: "This is a collection of my linux journey",
			location: "Linux",
			date: "2026-08-18",
			tags: ["linux", "rice", "ricing"],
			password: "3ildan123",
