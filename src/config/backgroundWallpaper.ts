...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/front.avif",
			"assets/images/DesktopWallpaper/invokedchaos.avif",
			"assets/images/DesktopWallpaper/leaves.avif",
			"assets/images/DesktopWallpaper/swimmingcat.avif",
			"assets/images/DesktopWallpaper/greeny.avif",
			"assets/images/DesktopWallpaper/qingxiao.avif",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/front.avif",
			"assets/images/MobileWallpaper/invokedchaos.avif",
			"assets/images/MobileWallpaper/leaves.avif",
			"assets/images/MobileWallpaper/swimmingcat.avif",
			"assets/images/MobileWallpaper/greeny.avif",
		],
		// 背景视频播放地址
		...
		playerUrl: "https://files.catbox.moe/p1kuta.mp4",
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
		...
		homeText: {
			...
			links: [
				...
				},
				{
					...
					url: "https://secretblog.my.id/sponsor/",
				},
				{
					name: "RSS",
					icon: "fa7-solid:rss",
