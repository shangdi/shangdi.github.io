...
Fitur yang juga saya suka dengan tema ini adalah semacam _highlight_ untuk baris dari sebuah _codeblock_. Contohnya seperti ini:[^7]
...
Terlepas dari itu semua, karena Firefly masih aktif di-_maintain_, saya yakin akan ada selalu _update-update_ fitur baru yang pastinya akan membuat _template_ ini menjadi makin menarik.
