...
<TabGroup labels={["Single", "Batch"]} client:load>
...
Kalau kita ingin memotong bagian-bagian gambar yang "tidak penting" sehingga hanya bagian-bagian gambar yang penting saja yang muncul, kita bisa potong dengan perintah:[^5]

```shell
magick <input_file.png> -trim <output_file.png>
```

Berikut contohnya:

![trimmed picture](../images/imagemagick/ss8.png)

Perhatikan. Bagian "hitam" pada gambar akan hilang "otomatis" dengan **_trim_**.
...
[^5]: https://varunbarad.com/blog/til-trim-image-background
